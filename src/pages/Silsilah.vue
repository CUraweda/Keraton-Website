<template>
  ...
  <div class="container">
    <img
      src="../assets/images/Line 17 (1).png"
      style="display: block; margin-left: -100px; margin-top: -15px"
    />
    <p class="Sulthan">
  ...
  <div class="container">
    ...
    <div>
      ...
      <div class="garis">
        <img
          src="../assets/images/Line 17.png"
          style="display: block; margin-left: -100px; margin-top: -10px"
        />
        <p>
  ...
  <div class="container">
    ...
    <div>
      ...
      <div class="garis">
        <img
          src="../assets/images/Line 17.png"
          style="display: block; margin-left: -100px; margin-top: -5px"
        />
        <p>
  ...
  <div class="container">
    ...
    <div>
      ...
      <img
        src="../assets/images/Frame.jpeg"
        style="margin-left: -106px; margin-top: 15px; margin-bottom: 50px"
      />
    ...
    <div>
      ...
      <img
        src="../assets/images/Line 17 (1).png"
        style="display: block; margin-left: -100px; margin-top: -0.5px"
      />
      <p class="Sulthan">
